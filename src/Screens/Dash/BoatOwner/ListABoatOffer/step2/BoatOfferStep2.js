          ...
          <div style={stepContainerStyle}>
            ...
            <form onSubmit={formik.handleSubmit}>
              <Grid container spacing={2} style={{ marginTop: "50px" }}>
                  ...
                  <CustomTextField
                    ...
                    onChange={
                      dash?.boatType?.length > 0
                        ? formik.handleChange
                        : (e) => {
                            formik.handleChange(e); // Let formik handle the change for boatType
                            console.log("e.target.value", e.target.value);
                            if (e.target.value === "Boat") {
                              formik.setFieldValue("boatName", "Boat"); // Set boatName to "Boat"
                            }
                          }
                    }
                    error={
                    ...
                    {dash?.boatType?.length > 0 ? (
                      ...
                      <>
                        <MenuItem
                          ...
                          selected={() => {
                            console.log("enter");
                            formik.setFieldValue("boatName", "Boat");
                          }}
                          // formik.values.boatType === "Boat"
                        >
                          {"Boat"}
                        </MenuItem>
                      </>
                ...
                {console.log("dash?.boatType?.length ", dash?.boatType?.length)}
                {/* Boat Year */}
                <Grid item xs={12} sm={6}>
                  <InputLabel htmlFor="boatName" style={inputLabelStyles}>
                    Boat Year
