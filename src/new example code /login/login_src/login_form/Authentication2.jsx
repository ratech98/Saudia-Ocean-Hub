...
import useAuthentication2ResponsiveSize from "./useAuthentication2ResponsiveSize";
...
const Pic = styled("div")({
  backgroundImage: `url(${IMAGES.PROFILE_ICON})`,
...
function Authentication2(props) {
  const { data } = useAuthentication2ResponsiveSize();
  ...
  return (
    <ScreenDesktop className={props.className} data={data}>
      <LeftSide data={data}>
        <LogIn data={data}>
          <Top data={data}>
            <Logo src={IMAGES.PROFILE_ICON} loading="lazy" alt={"Logo"} />
            <Lockup>
